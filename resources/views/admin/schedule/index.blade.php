...
<html lang="en">
  <head>
    ...
    <title>SMP 3 Muhammadiyah | Daftar Jadwal Pelajaran</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Tabel Daftar Jadwal Pelajaran</h3>
              </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td style="display: flex; align-items: center;">
                                        ...
                                        <form action="{{ route('dashboard.schedule.delete', $schedule->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Apakah anda yakin ingin menghapus jadwal pelajaran ini?');">
                                            @csrf
                                            @method('DELETE')
