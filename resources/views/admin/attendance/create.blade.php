				...
				<div class="row">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="nisn" required="required" class="form-control">
                    </div>
                  </div>
                  <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="course_id">nisn Pelajaran <span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 ">
