            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{route('dashboard.admin.create')}}"><i class="fa fa-plus"></i>Kehadiran Manual</a>
                  </li>
                      ...
                      <div class="row">
                          <div class="col-sm-12">
                            <div class="card-box table-responsive">
                              <form action="{{ route('dashboard.teacher_list.create') }}" method="GET" style="display:inline;">
                                  ...
                                  @foreach($teachers as $key => $teacher)
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <form action="{{ route('dashboard.teacher_list.reset_password', $teacher->id) }}" method="GET">
                                            @csrf
                                      ...
                                      <td style="display: flex; align-items: center;">
                                        <form action="{{ route('dashboard.teacher_list.edit', $teacher->id) }}" method="GET" style="display: inline-block;">
