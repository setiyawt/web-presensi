          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Tabel Daftar Mata Pelajaran</h3>
              </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td style="display: flex; align-items: center;">
                                        ...
                                        <form action="{{ route('dashboard.course.delete', $course->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Apakah anda yakin ingin menghapus mata pelajaran ini?');">
                                            @csrf
                                            @method('DELETE')
